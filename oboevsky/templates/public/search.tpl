        ...
        <ul>
            {% block menu_categories %}
                ...
                <li>
                    ...
                    <ul>
                        <li>От: <input type="text" name="min_price" value="{{min_price}}" class="search_price_input" /> рублей</li>
                        <li>До: <input type="text" name="max_price" value="{{max_price}}" class="search_price_input" /> рублей</li>
                    </ul>
                </li>
