    ...
    <div id="contentWrapper" class="clear">
        ...
        <div id="content">
            ...
            <div class="contentBlockNoBorder">
                <div id="breadcrumps">
                    <a href="#">Главная</a> / <a href="#">Акции и скидки</a> / Распродажа
                </div>
                <div id="producerProfile">
                    <h1>Распродажа</h1>
                    <p>Только в нашем интернет магазине обоев! Только до 31-го августа!</p>
                    <p>Самые популярные обои от всех производителей по самым низким ценам. <span class="red">Скидки до 50 %.</span> Спешите сделать заказ! А наши дизайнеры с радостью помогут Вам сделать правильный выбор. <span class="red">Количество товара ограничено.</span></p>
                    <h1 class="red">Товары со скидкой:</h1>
                </div>
            </div>
                ...
                <div>
                    ...
                    <div class="items clear">
                        <div class="item">
                            ...
                            <p>39330 Обои Emiliana Parati Superb</p>
                            <p>&nbsp;</p>
                            <div class="right bold red">Скидка 99%</div>
                            <p class="bold">1717 руб</p>
