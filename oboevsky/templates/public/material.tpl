    ...
    <div id="contentWrapper" class="clear">
        ...
        <div id="content">
            ...
            <div class="contentBlockNoBorder">
                <div id="breadcrumps">
                    <a href="#">Главная</a> / <a href="#">Материалы</a> / Винил
                </div>
                <div id="producerProfile">
                    <h1>Виниловые обои</h1>
                    <p>Виниловые обои — это настенное покрытие, состоящее из двух слоев: нижнего – флизелина или бумаги, и верхнего слоя – поливинилхлорида, способного противостоять загрязнениям и механическим повреждениям. На верхний слой виниловых обоев наносится рисунок или тиснение.</p>
                    <img class="right" src="static/images/sample_material.jpg" alt="" />
                    <p>История виниловых обоев берет свое начало в 1947 году, именно тогда они были впервые представлены в США. На нашем ранке виниловые обои появились позже: в начале 70-х годов. Раньше такие обои не были воздухопроницаемыми и их в основном клеили в нежилых помещениях — коридоре, кухне, ванной.</p>
                    <p>Благодаря современным развивающимся технологиям, многие производители наладили выпуск виниловых обоев, способных обеспечивать влагообмен с окружающей средой с помощью микропор. Благодаря микропорам конденсат испаряется из-под покрытия, но в тоже время при мытье обоев микропоры препятствуют попаданию влаги под обои.</p>
                    <p>Благодаря прочности, долговечности и разнообразному дизайну виниловых обоев, они пользуются большой популярностью, но стоят они значительно дороже остальных обоев. Все же, как показывают последние данные, высокая цена ничуть не уменьшает спрос на этот материал для покрытия стен. Да и не только стен, ведь виниловыми обоями можно покрывать и потолки.</p>
                    <p>Существует несколько видов виниловых обоев: вспененный винил, который имеет ярко выраженную фактуру; плоские виниловые обои или компакт-винил, имеющие гладкую поверхность, и особо плотный тяжелый винил.</p>
                </div>
                <h1>Виниловые обои</h1>
            </div>
