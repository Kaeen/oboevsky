    ...
    <div id="contentWrapper" class="clear">
        ...
        <div id="content">
            ...
            <div class="contentBlockNoBorder">
                <div id="breadcrumps">
                    <a href="#">Главная</a> / Обои 1829-20 AS Creation
                </div>
                <div id="itemInfo" class="clear">
                    <h1>Обои 1829-20 AS Creation</h1>
                    ...
                    <div class="itemAttribute clear">
                        ...
                        <div class="left">1829-20</div>
                    </div>
                    <div class="itemAttribute clear">
                        <div class="caption">Торговая марка:</div>
                        <div class="left">Обои AS Creation</div>
                    </div>
                    <div class="itemAttribute clear">
                        <div class="caption">Страна-производитель:</div>
                        <div class="left">Германия</div>
                    </div>
                </div>
            </div>
